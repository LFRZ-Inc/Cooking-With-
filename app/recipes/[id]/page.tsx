...
const demoRecipes = [
  ...
  },
  {
    ...
    image_url: "https://images.unsplash.com/photo-1565299585323-38174c7e9b72?w=800",
    ...
    instructions: [
      "In a blender, combine achiote paste, orange juice, vinegar, garlic, chipotle peppers, salt, and pepper to make marinade.",
      "Marinate sliced pork in the mixture for at least 2 hours or overnight in refrigerator.",
      "Thread marinated pork onto skewers, alternating with pineapple pieces.",
      "Cook on a hot grill or comal for 3-4 minutes per side until slightly charred and cooked through.",
      "Warm tortillas on the grill for 30 seconds per side.",
      "Slice the cooked pork and pineapple thinly.",
      "Serve on warm tortillas topped with diced onion, cilantro, and lime wedges.",
      "Accompany with salsa verde and additional lime wedges."
    ],
  ...
  },
  {
    ...
    author: "Luis Rodriguez",
    ingredients: [
      "Fresh ramen noodles (4 portions)",
      "Pork bones (2 lbs, split)",
      "Chashu pork belly (1 lb)",
      "Eggs (4 large)",
    ...
    instructions: [
      "Place pork bones in a large pot, cover with water, and bring to a rolling boil. Cook for 3 hours, skimming foam regularly.",
      "For soft-boiled eggs: bring water to boil, gently add eggs, cook for 6.5 minutes, then transfer to ice bath.",
      "Season pork belly with salt and sear in a hot pan until browned. Add to the broth for the last hour.",
      "Strain the broth and return to pot. Whisk in miso paste until dissolved.",
      "Cook ramen noodles according to package directions and divide among bowls.",
      "Slice the chashu pork belly and peel the soft-boiled eggs, cutting in half.",
      "Ladle hot broth over noodles and top with chashu, soft-boiled egg halves, green onions, and nori.",
      "Serve immediately with additional soy sauce and chili oil on the side."
    ],
  ...
  },
  {
    ...
    instructions: [
      "Cook quinoa in salted water according to package directions. Let cool completely.",
      "In a large bowl, combine cooled quinoa, cherry tomatoes, cucumber, and red onion.",
      "Add crumbled feta cheese, olives, parsley, and mint.",
      "In a small bowl, whisk together lemon juice, olive oil, and minced garlic.",
      "Pour dressing over salad and toss gently to combine.",
      "Season with salt and pepper to taste.",
      "Let salad rest for 15 minutes to allow flavors to meld.",
      "Serve at room temperature or chilled. Best consumed within 2 days."
    ],
  ...
  },
  {
    ...
    ingredients: [
      ...
      "Optional: spam or leftover meat"
    ],
    instructions: [
      "Heat vegetable oil in a large pan or wok over medium-high heat.",
      "Add minced garlic and stir-fry for 30 seconds until fragrant.",
      "Add chopped kimchi and cook for 2-3 minutes until slightly caramelized.",
      "Add day-old rice, breaking up any clumps with a spatula.",
      "Stir in kimchi juice, soy sauce, and gochujang, mixing well.",
      "Cook for 5-7 minutes, stirring frequently, until rice is heated through and slightly crispy.",
      "In a separate pan, fry eggs sunny-side up with crispy edges.",
      "Divide fried rice among bowls and top each with a fried egg.",
  ...
  },
  {
    ...
    ingredients: [
      ...
      "Thick-cut bacon (6 strips, chopped)",
      "Pearl onions (1 lb, peeled)",
      "Button mushrooms (8 oz, halved)",
    ...
    instructions: [
      "In a large Dutch oven, cook chopped bacon until crispy. Remove and set aside.",
      "Season chicken thighs with salt and pepper, then brown in bacon fat on all sides. Remove chicken.",
      "Add pearl onions to the pot and cook until golden brown. Remove and set aside.",
      "Add mushrooms and cook until browned. Remove and set aside.",
      "Add garlic and tomato paste, cook for 1 minute until fragrant.",
      "Pour in red wine, scraping up any browned bits. Add thyme and bay leaves.",
      "Return chicken to pot, bring to a simmer, cover and cook for 45 minutes.",
      "Add pearl onions back to pot and cook for 15 more minutes until tender.",
      "Mix butter and flour to make a paste, whisk into sauce to thicken.",
      "Return bacon and mushrooms to pot, simmer 5 minutes more.",
      "Remove thyme sprigs and bay leaves, garnish with fresh parsley and serve."
    ],
