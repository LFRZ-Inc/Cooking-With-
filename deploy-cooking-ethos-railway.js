...
/**
 * 🍳 Deploy Cooking Ethos AI to Railway
 * 
 * This script deploys the Cooking Ethos AI to Railway for seamless integration
 * with the Cooking With! app without requiring users to run their own servers.
 */
...
// Configuration
const RAILWAY_PROJECT_ID = '03fae9e5-6ae9-4531-b68f-f1120ff7a96b';
const SERVICE_ID = '3039c477-ddcc-4a33-8cbe-29a01fc6dfe3';
...
try {
  ...
  console.log('⚠️  Project already linked or error occurred, continuing...');
}
